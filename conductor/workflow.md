...
8. **Propose Commit for Code Changes:**
   ...
   - **Step 8.2: Suggest Commit:** Present the staged changes and the drafted summary to the user. Ask for permission to commit using the summary as the commit message body. For example:
     ...
     Changes:
     - Added index.html with main container
     - Defined grid layout for buttons
     - Added display area for results
     Why: Provides the foundational UI for the calculator functionality.
     ```
...
10. **Propose Commit for Plan Update:**
    - **Action:** Propose to commit the plan update with a descriptive message (e.g., `conductor(plan): Mark task 'Create user model' as complete`).
...
3. **Execute Automated Tests with Proactive Debugging:**
   ...
   - **Example Announcement:** "I will now run the automated test suite to verify the phase. **Command:** `pytest && npm test`"
...
4. **Propose a Detailed, Actionable Manual Verification Plan:**
   ...
   - The plan you present to the user **must** follow this format:
     ...
     **Manual Verification Steps:**
     1.  **Start the development server with the command:** `npm start` (in src/webapp/frontend)
     ...
     **Manual Verification Steps:**
     1.  **Ensure the server is running:** `uvicorn app.main:app --reload` (in src/webapp/backend)
...
6. **Propose Checkpoint Commit:**
   - Suggest to create a checkpoint commit with a clear and concise message (e.g., `conductor(checkpoint): Checkpoint end of Phase X`).
...
8. **Propose Commit for Plan Update:**
...
- [ ] Type safety is enforced (e.g., type hints, TypeScript types)
- [ ] No linting or static analysis errors (using pylint and gts)
